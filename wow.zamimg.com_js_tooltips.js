window.WH = new (function () {
  this.REMOTE =
    (!("." + location.hostname).endsWith(".wowhead.com") &&
      location.hostname !== "wh-site") ||
...
WH.dataTree = { RETAIL: 1, CLASSIC: 4, TBC: 5, D2: 6, DI: 7, WRATH: 8, D4: 9 };
...
WH.Types = new (function () {
  ...
  function d(e) {
    ...
    return (
      c.typeNames[e] || Array(4).fill(WH.term("unknownType_format", e), 0, 4)
    );
  }
})();
WH.error = function (e) {
  ...
  if (WH.Track) {
    WH.Track.nonInteractiveEvent.apply(
      WH.Track,
...
WH.PageMeta.serverTime = WH.PageMeta.serverTime
  ? new Date(WH.PageMeta.serverTime)
  : new Date();
...
WH.wowTerm = function (e) {
  ...
  let t = [WH.GlobalStrings[e]].concat(
...
WH.numberFormat = function (e) {
  ...
  return (
    WH.numberFormat(e.substr(0, e.length - 3)) +
    "," +
    e.substr(e.length - 3) +
    a
  );
...
WH.ac = function (e, t) {
  ...
  while (e) {
    ...
    if (
      e.style.transform &&
      (t = e.style.transform.match(/scale\(([\d.]+)\)/i))
    ) {
      a *= parseFloat(t[1]);
      i *= parseFloat(t[1]);
    }
  ...
  if (t.asNeeded) {
    ...
    if (
      ...
      (t.allowScrollingDown ?? true
        ? a.top + a.height + i < window.innerHeight
        : true) &&
      a.left >= i &&
...
WH.getDomainFromLocale = function (e) {
  ...
  if (WH.getDomainFromLocale.L) {
    ...
    t = WH.getDomainFromLocale.L = WH.createReverseLookupJson(
      WH.getLocaleFromDomain.L
    );
  }
  return t[e] ? t[e] : "";
...
WH.getDataEnv = function () {
  return WH.PageMeta.hasOwnProperty("dataEnv")
    ? WH.PageMeta.dataEnv.env
    : WH.dataEnv.MAIN;
};
...
WH.getDataCacheVersion = function (e) {
  return (
    (WH.PageMeta.activeDbChanged &&
      WH.PageMeta.activeDbChanged[e || WH.getDataEnv()]) ||
    "0"
  ).toString();
};
WH.isBeta = function () {
...
WH.effectAverage = function (e, t, a, i) {
  ...
  if (r != 0 && s != 0) {
    ...
    if (s == WH.EFFECT_SCALING_CLASS_7 && e["aura"] && e["aura"][i] == 4) {
...
WH.convertScalingSpell = function (e, t, a, i, n, s) {
  ...
  if (
    window.g_pageInfo &&
    window.g_pageInfo.type == WH.Types.AZERITE_ESSENCE_POWER
  ) {
...
WH.applyStatModifications = function (e, t, a, i, n, s, r, o) {
  ...
  if (n && n.length) {
      ...
      if (u > 0 && WH.isSet("g_itembonuses") && g_itembonuses[u]) {
        ...
        for (var h = 0; h < p.length; ++h) {
          ...
          switch (g[0]) {
            ...
            case 5:
              c.nameSuffix =
                WH.Wow.Item.getNameDescription(g[1]) || c.nameSuffix;
              break;
            case 6:
    ...
    for (var h = 0; h < 4; ++h) {
      ...
      if (e) {
        ...
        if (!h) {
          c.namedesccolor = WH.Wow.Item.getNameDescriptionColor(W[h]);
        }
      }
    }
  }
  ...
  if (
    ...
    for (var f in WH.statToJson) {
      ...
      if (c[C] || (c.statsInfo && c.statsInfo[f])) {
        ...
        if (C == "sta") {
          c[C] =
            c[C] *
            WH.getStaminaRatingMult(c.level, c.slot || g_items[c.id].slot);
        } else if (
          r &&
          WH.inArray(WH.applyStatModifications.BASE_STATS, f) < 0
        ) {
          c[C] =
            c[C] *
            WH.getCombatRatingMult(c.level, c.slot || g_items[c.id].slot);
    ...
    if (c["dps"]) {
      ...
      var x = WH.getEffectiveWeaponDamage(c, false);
      var P = WH.getEffectiveWeaponDamage(c, true);
      x = Math.floor(Math.max(1, x));
      P = Math.max(1, P);
      if (!WH.isRetailTree()) {
        x = c.damagemin || c.dmgmin1 || x;
        P = c.damagemax || c.dmgmax1 || P;
      }
      let e = 0;
      if (_) {
        let t = null;
        ...
        if (g[s] && g[s][t]) {
          ...
          P = Math.floor(e * c.speed * (1 + c.dmgrange / 2) + 0.5);
          c["dmgmin1"] = x;
          c["dmgmax1"] = P;
        }
      } else {
...
WH.applyStatModifications.BASE_STATS = [
...
WH.setItemModifications = function (e, t, a, i, n, s, r) {
  ...
  i = !s ? i : null;
  var l = WH.applyStatModifications(
    g_items[t].jsonequip,
    0,
    i,
    s,
  ...
  e = e.replace(h, function (e, t, a) {
    return (
      t + WH.numberFormat(l.dmgmin1) + (p ? a + WH.numberFormat(l.dmgmax1) : "")
    );
  });
    ...
    e = e.replace(/<!--ebstats-->/, function (e) {
      ...
      for (var a = 0; a < l.extraStats.length; ++a) {
        ...
        var n =
          ...
          ((WH.statToJson &&
            WH.statToJson[i] &&
            WH.Wow.Item.Stat.jsonToName(WH.statToJson[i])) ||
            "Unknown");
  ...
  e = e.replace(/(<!--ndstart-->)(.*)(<!--ndend-->)/, function (e, t, a, i) {
    ...
    var n = parseInt(l.namedesccolor).toString(16);
    while (n.length < 6) {
      n = "0" + n;
    }
    return (
  ...
  if ((!W && l.nsockets) || (W && l.nsockets > W)) {
    ...
    e = e.replace(/<!--ps-->(<br(?: \/)?>)?/, function (e, f) {
      ...
      for (var S = W; S < l.nsockets; ++S) {
        ...
        var y = WH.sprintf(
          '<a href="' + WH.Strings.escapeHtml(W) + '" class="$1 q0">',
          I
        );
  ...
  if (WH.applyStatModifications && WH.convertScalingSpell.SpellInformation) {
    ...
    while ((H = T.exec(e)) !== null) {
      ...
      E[I] = E[I] || {};
      let e =
        l.scadistbonus && l.scadistbonustype === 13
          ? g_items[t].level
          : l.level;
  ...
  e = e.replace(/(<!--rtg%(\d+)-->)([\.,0-9]+)%?/g, function (t, a, i, s) {
    ...
    return (
      a +
      (_[2] ? "~" : "") +
      Math.round(WH.convertRatingToPercent(n ? n : WH.maxLevel, i, r) * 100) /
        100 +
      (i != 49 ? "%" : "")
    );
  });
          ...
          WH.ce(
            ...
            WH.ct(
              t[e][2]
                ...
                : WH.Strings.sprintf(
                    WH.GlobalStrings.ITEM_UPGRADE_TOOLTIP_FORMAT,
                    t[e][0],
                    t[e][1]
                  )
            )
  ...
  e = e.replace(/<!--ue-->/, function () {
    ...
    if (t) {
      ...
      e = WH.Strings.escapeHtml(
        a +
          WH.TERMS.colon_punct +
          WH.Strings.sprintf(WH.TERMS.parens_format, t.name, t.maxCount)
      );
      e = "<br />" + e;
    }
    return e;
...
WH.setTooltipLevel = function (e, t, a) {
  ...
  e = e.replace(/(<!--rtg%(\d+)-->)([\.0-9]+)%?/g, function (a, i, n, s) {
    ...
    return (
      i +
      Math.round(WH.convertRatingToPercent(t, n, _[1]) * 100) / 100 +
      (n != 49 ? "%" : "")
    );
  });
...
WH.adjustSpellPoints = function (e, t, a, i) {
  ...
  for (var s = 1; s <= 20; ++s) {
    e = e.replace(
      ...
      function (e, a, i, r, o) {
        var l =
          t[a] && t[a].hasOwnProperty("effects")
            ? t[a].effects[s]
            : t.effects[s];
        if (!l) {
          return e;
    ...
    e = e.replace(
      ...
      function (e, a, i, r, o, l) {
        var c =
          t[i] && t[i].hasOwnProperty("effects")
            ? t[i].effects[s]
            : t.effects[s];
        if (!c) {
          return e;
...
WH.setTooltipSpells = function (e, t, a, i, n = 0) {
    ...
    for (let e in a) {
      ...
      for (var r = 0; r < a[e].length; r++) {
        ...
        for (var l = 0; l <= 1; l++) {
          var c = -1;
          while (
            (c = a[e][r].data[l].indexOf("\x3c!--sp" + e + "--\x3e", c + 1)) >=
            0
          ) {
            o++;
          }
  ...
  while ((g = h.exec(e))) {
    ...
    while (v && v.index < E) {
      ...
      if (E < 0) {
        WH.warn(
          "Could not find nested closing end tag for tooltip spell.",
          H,
          e
        );
        return e;
  ...
  for (var b = 0; b < p.length; ++b) {
    ...
    var L =
      "\x3c!--sp" + y + ":" + w + "--\x3e" + A + "\x3c!--sp" + y + "--\x3e";
    e = e.substr(0, S) + e.substr(S).replace(p[b], L);
    S = e.indexOf(L, S) + L.length;
    if (w) {
      for (var R = b + 1; R < p.length; R++) {
        if (e.indexOf(p[R], S) !== S) {
          break;
        }
        g = p[R].match(I);
        L = g[1] + g[3];
        e = e.substr(0, S) + e.substr(S).replace(p[R], L);
        u(g[2]);
        S += L.length;
        b++;
      }
...
WH.enhanceTooltip = function (e, t, a, i, n, s, r, o, l, c, d, f, u) {
  if (
    (!WH.applyStatModifications || !WH.applyStatModifications.ScalingData) &&
    (u || o)
  ) {
    g_itemScalingCallbacks.push(
      (function (p) {
        return function () {
          var h = WH.enhanceTooltip.call(
            p,
            e,
            t,
            a,
  ...
  if (a) {
    var T = WH.getGets();
    if (T.lvl) {
      e = WH.setTooltipLevel(e, T.lvl, n);
    }
    E = T.ilvl;
  }
  ...
  if ((u || o || I.length) && g) {
    e = WH.setItemModifications(
      ...
      u,
      o,
      this._selectedLevel ? this._selectedLevel : null,
      E,
      I
    );
  }
    ...
    if (e.indexOf("\x3c!--artpow:") > 0) {
      ...
      e = e.replace(/(<!--ndstart-->)?<!--ndend-->/i, function (e, t) {
        return (
          ...
          WH.sprintf(WH.TERMS.knowledge_format.replace("%d", "$1"), y) +
          "</a>"
        );
      });
      e = e.replace(/(<!--artpow:(\d+)-->)[\d\.\,]+/, function (e, t, a) {
        return (
          ...
          WH.numberLocaleFormat(
            WH.roundArtifactPower(
              parseInt(a) * WH.getArtifactKnowledgeMultiplier(y)
            )
          )
        );
      });
  ...
  if (i && Slider) {
    var w = WH.groupSizeScalingShouldShow(g);
    if (n) {
      n.bufftip = this;
      if (w && WH.isSet("g_difficulties") && g_difficulties[w]) {
        e = WH.groupSizeScalingOnChange.call(
          n,
          this,
          g_difficulties[w].maxplayers,
          1,
          true
        );
      }
      ...
      if (!A && !WH.isRetailTree()) {
        ...
        var L = e.match(_);
        if (L) {
          A = [null, null, L[2], WH.maxLevel, WH.maxLevel];
        }
      }
      if (w && WH.isSet("g_difficulties") && g_difficulties[w]) {
        var R = WH.ce("label");
        ...
        if (A[2] != A[3]) {
          ...
          WH.Tooltip.simple(
            Slider.getInput(this.slider),
            WH.TERMS.clicktochangelevel_stc,
            "q2"
          );
        }
      }
    ...
    if (L) {
      ...
      if (this._rppmModList.hasOwnProperty(4)) {
        ...
        if (C.is(":empty")) {
          ...
          C.append(WH.getMajorHeading(WH.TERMS.realppmmodifiers, 2, 3));
          for (var M in this._rppmSpecModList) {
            var N = Icon.create(this._rppmSpecModList[M]["filename"], 0, null);
            N.style.display = "inline-block";
            N.style.verticalAlign = "middle";
            var O = $(
              '<input name="rppmmod" type="radio" id="rppm-' + M + '" />'
            );
            O.get(0).checked = this._rppmSpecModList[M]["spec"] == -1;
            C.append(O)
              .append(this._rppmSpecModList[M]["spec"] == -1 ? "" : N)
              .append(
                '<label for="rppm-' +
                  M +
                  '"> <a>' +
                  (this._rppmSpecModList[M]["spec"] == -1
                    ? WH.TERMS.none
                    : WH.Wow.PlayerClass.Specialization.getName(
                        this._rppmSpecModList[M]["spec"]
                      )) +
                  "</a></label>"
              )
              .append("<br />");
            var k = this;
            $("#rppm-" + M).change(function () {
              WH.tooltipRPPMChange.call(this, k);
            });
          }
        } else {
          var D = this._rppmModBase;
      ...
      if (this._rppmModList.hasOwnProperty(1)) {
        P += " + " + WH.Wow.Item.Stat.jsonToAbbr("hastertng");
      } else if (this._rppmModList.hasOwnProperty(2)) {
        P += " + " + WH.Wow.Item.Stat.jsonToAbbr("critstrkrtng");
      }
      ...
      if (P.length > 0) {
        e = e.replace(
          /<!--rppm-->\[?(\d+(?:\.\d+)?)([^<]*)<!--rppm-->/,
          function (e, t, a) {
            return "\x3c!--rppm--\x3e[" + t + P + "]" + a + "\x3c!--rppm--\x3e";
          }
        );
      }
    }
  ...
  if (W == 3) {
    var F = $("#cs" + g);
    if (F && WH.Wow.Item.tooltipHasSpecStats(e)) {
      if (!this._classSpecBtn) {
        var U = WH.ce("label");
        U.innerHTML = WH.TERMS.showingtooltipfor_stc + " ";
        ...
        F.append(U).append(this._classSpecBtn).show();
      }
      B = WH.LocalStorage.get(WH.LocalStorage.KEY_WOW_DATABASE_SPEC_FILTER);
      if (typeof B !== "object") {
        B = null;
      }
      var q = /(&|\?)class=(\d+)/.exec(location.href);
      if (q) {
        B = { classId: parseInt(q[2]), specId: 0 };
      }
      ...
      if (G) {
        ...
        if (j) {
          B = { classId: j, specId: z };
        }
      }
      if (B) {
        e = WH.classSpecBtnOnChange.call(this, B.classId, B.specId, e, true);
      } else {
        $(this._classSpecBtn).text(
          WH.isRetailTree()
            ? WH.TERMS.chooseaspec_stc
            : WH.TERMS.chooseAClass_stc
        );
      }
    }
  }
  ...
  (function () {
    ...
    WH.ae(
      ...
      WH.ce(
        "label",
        {},
        WH.ct(WH.TERMS.optionalReagentStats + WH.TERMS.colon_punct)
      )
    );
        ...
        Menu.createItem({
          ...
          options: {
            checkedFunc: function (e) {
              return S().includes(parseInt(e[Menu.ITEM_CRUMB]));
            },
          },
        })
      );
  ...
  if (v["spec"]) {
    e = WH.Tooltips.parseItemEffectTooltipForSpec(e, parseInt(v["spec"]));
  }
  return e;
};
...
WH.difficultyBtnBuildMenu = function (e) {
  ...
  for (var i = 0; i < a.difficulties.length; ++i) {
    ...
    var s = [
      n,
      WH.Wow.Difficulty.getName(n),
      WH.difficultyBtnOnChange.bind(this, n, false),
    ];
    t.push(s);
  }
...
WH.difficultyBtnOnChange = function (e, t) {
  ...
  if (n != s) {
    ...
    WH.Tooltip.simple(
      Slider.getInput(this.slider),
      WH.TERMS.clicktochangeplayers_stc,
      "q2"
    );
  }
...
WH.classSpecBtnOnChange = function (e, t, a, i) {
  ...
  o = o.replace(
    ...
    function (t, a, i, n, s, r) {
      ...
      var o =
        a == 2 &&
        (!g_classes_allowed_weapon[e] ||
          WH.inArray(g_classes_allowed_weapon[e], i) == -1);
      var l =
        a == 4 &&
        (!g_classes_allowed_armor[e] ||
          WH.inArray(g_classes_allowed_armor[e], i) == -1);
      if (o || l) {
        n = 10;
      }
      return (
    ...
    o = o.replace(
      ...
      function (e, a, i, n, s) {
        ...
        if (
          ...
          g_items[g_pageInfo.typeId].hasOwnProperty(
            "affectsArtifactPowerTypesData"
          ) &&
          g_items[
            g_pageInfo.typeId
          ].affectsArtifactPowerTypesData.hasOwnProperty(i) &&
          g_items[g_pageInfo.typeId].affectsArtifactPowerTypesData[
            i
          ].hasOwnProperty(t)
        ) {
...
WH.classSpecBtnBuildMenu = function (e) {
  ...
  for (var n in g_chr_specs_by_class) {
    var s = g_chr_specs_by_class[n];
    for (var r in t) {
      var o = t[r];
      if (o[Menu.ITEM_CRUMB] == n) {
        if (!WH.isRetailTree()) {
          o[Menu.ITEM_URL] = WH.classSpecBtnOnChange.bind(this, n, 0, false);
        } else {
          if (o[Menu.ITEM_URL]) {
            o[Menu.ITEM_URL] = null;
          }
          for (var l = 0, c = s.length; l < c; l++) {
            var d = Menu.getSubmenu(t[r]);
            for (var f = 0, u = d.length; f < u; f++) {
              var p = d[f];
              if (p[Menu.ITEM_CRUMB] == s[l]) {
                if (e && WH.inArray(e, s[l]) < 0) {
                  delete p[Menu.ITEM_OPTIONS].tinyIcon;
                  p[Menu.ITEM_OPTIONS].className = "q0";
                  p[Menu.ITEM_URL] = "javascript:";
                } else {
                  p[Menu.ITEM_URL] = WH.classSpecBtnOnChange.bind(
                    this,
                    n,
                    s[l],
                    false
...
WH.updateItemStringLink = function () {
  ...
  if (e[t]) {
    ...
    var o =
      this._classSpecBtn && this._classSpecBtn.selectedSpec
        ? this._classSpecBtn.selectedSpec
        : "";
    var l = 0;
    var c = "";
    if (n) {
    ...
    if (g) {
      var m = {
        ...
        linkColor:
          "ff" +
          WH.Wow.Item.getQualityColor(e[t].quality, true).replace(/^#/, ""),
        linkId: "item:" + t + "::::::::" + s + ":" + o + ":" + h,
...
WH.staticTooltipLevelClick = function (e, t, a, i) {
  ...
  s = WH.setTooltipLevel.bind(
    e,
    d[r][(i ? "buff_" : "tooltip_") + Locale.getName()],
    t,
    i
  )();
  var f =
...
WH.staticTooltipKnowledgeLevelClick = function (e, t, a) {
  ...
  if (isNaN(t)) {
    ...
    t = prompt(
      WH.sprintf(
        WH.TERMS.ratinglevel_format,
        0,
        g_artifact_knowledge_max_level
      ),
  ...
  var n = WH.getDataSource();
  i = WH.setTooltipLevel.bind(
    e,
    n[a]["tooltip_" + Locale.getName()],
    e._selectedLevel,
    null
  )();
  var s =
...
WH.tooltipSpellsChange = function () {
  ...
  this.modified[2] = a;
  WH.qsa(".lazy-load-background", this).forEach((e) =>
    e.classList.remove("lazy-load-background")
  );
...
WH.tooltipRPPMChange = function (e) {
  ...
  WH.qsa(".lazy-load-background", e).forEach((e) =>
    e.classList.remove("lazy-load-background")
  );
    ...
    e.innerHTML.replace(
      ...
      function (a, i, n, s) {
        return (
          ...
          (
            e._rppmModBase *
            (1 + parseFloat(e._rppmSpecModList[t].modifiervalue))
          ).toFixed(2) +
          s +
          "\x3c!--rppm--\x3e"
        );
...
WH.createButton = function (e, t, a) {
  ...
  if (typeof a["tooltip"] != "undefined") {
    ...
    if (a["tooltip"] === false) {
      ...
      WH.Tooltip.simple(u, a["tooltip"]);
    } else if (typeof a["tooltip"] == "object" && a["tooltip"]["text"]) {
      WH.Tooltip.simple(u, a["tooltip"]["text"], a["tooltip"]["class"]);
    }
  }
  return u;
};
WH.D4 = new (function () {
  this.getImageUrlFromHash = (e) => {
    if (typeof e === "string") {
      e = parseInt(e);
    }
    let t = "/d4/texture/";
...
WH.Game = new (function () {
  ...
  this.getDataTrees = (e) => t[e]?.dataTrees;
  this.getDefaultEnv = (e) => i[e];
  this.getEnv = (t) => {
    t = t || e.DEFAULT;
    return t === WH.Game.get() ? WH.getDataEnv() : WH.Game.getDefaultEnv(t);
  };
  this.getName = (e) => (t[e] ? WH.TERMS[t[e].term] : undefined);
  this.getAbbrev = (e) => (t[e] ? WH.TERMS[t[e].termAbbrev] : undefined);
  this.getKey = (e) => a[e];
  this.getRoot = (t) => WH.getRootEnv(e.getEnv(t));
  this.getSelectorByDataEnv = (e) => n[e];
  ...
  this.hasAccess = (t) => {
    let a = (e.getDataTrees(t) || []).filter((e) => {
      for (let [t, a] of Object.entries(WH.dataEnvToTree)) {
        ...
        return WH.PageMeta.availableDataEnvs.includes(e);
      }
    });
    return !!a.length;
  };
...
WH.Fonts = new (function () {
  ...
  function r(e) {
    ...
    if (
      document.head.querySelector('link[rel="stylesheet"][href="' + e + '"]')
    ) {
      return;
    }
    WH.ae(
      document.head,
      WH.ce("link", { href: e, rel: "stylesheet", type: "text/css" })
    );
  }
})();
WH.Icon = new (function () {
  ...
  this.create = function (n, s, r, o) {
    ...
    let l =
      o.dataEnv ||
      (o.type && i.getPreferredDataEnv(o.type)) ||
      t.getEnv(o.game);
    let c = t.getByEnv(l);
    if (s === e.TINY) {
      return WH.ce("img", {
        className: "icontiny",
        src: e.getIconUrl(n, s, c),
      });
    }
    ...
    if (n) {
      if (n.includes("/")) {
        ...
        e.setImage(d, e.getIconUrl(n, s, c), false, o.isMask);
      }
    ...
    if (r) {
      ...
      if (!e) {
        if (r !== null) {
          WH.ae(d, WH.ce("a", { href: "javascript:" }));
    ...
    switch (a) {
      case i.DI_EQUIP_ITEM:
        ...
        s.dataset.gridType =
          s.gridType ||
          t.gridType ||
          ([6, 11, 4, 3, 7, 9, 8].includes(t.inventoryPosition)
            ? o.GRID_TYPE_1x1
            : o.GRID_TYPE_2x1);
        delete s.gridType;
      ...
      case i.DI_PARAGON_SKILL:
        s.dataset = s.dataset || {};
        s.dataset.specSkill = JSON.stringify(
          !!(s.isSpecSkill || t.isSpecSkill)
        );
        break;
  ...
  this.getIconUrl = function (a, i, s) {
    if (n.indexOf(i) === -1) {
      i = e.MEDIUM;
    }
    if (s === t.DI) {
      ...
      return WH.D4.getImageUrlFromHash(a);
    }
    let r = t.getKey(s || t.DEFAULT);
    if (!r) {
      WH.warn('Invalid game provided for "' + a + '" icon: ' + s);
      r = t.getKey(t.WOW);
      a = e.UNKNOWN;
    }
    return (
  ...
  this.setText = function (e, t, a) {
    ...
    if (
      t != null &&
      ((t > 1 && t < 2147483647) || (t.length && t !== "0" && t !== "1"))
    ) {
      WH.ae(
        e,
        WH.ce(
          "span",
          { className: "wh-icon-text", dataset: { type: "number" } },
          WH.ct(t)
        )
      );
    }
...
var Icon = {
  ...
  createUser: function (e, t, a, i, n, s, r) {
    ...
    if (e == 2)
      Icon.moveTexture(
        o,
        a,
        Icon.premiumOffsets[a][0],
        Icon.premiumOffsets[a][1],
        true
      );
    ...
    if (a || i) {
      if (n) s.backgroundPosition = a + "px " + i + "px";
        ...
        s.backgroundPosition =
          -a * Icon.sizes2[t] + "px " + -i * Icon.sizes2[t] + "px";
  ...
  showIconInfo: function (e) {
    if (e.firstChild) {
      ...
      if (
        ...
        if (e) {
          Icon.displayIcon(e[2], WH.Game.getByKey(e[1]));
        }
      }
    }
  },
  ...
  displayIcon: function (e, t) {
        ...
        fields: [
          {
            ...
            compute: function (e, a, i, n) {
              ...
              s.update = function () {
                ...
                WH.ae(
                  s,
                  WH.Icon.create(e.value, WH.Icon.LARGE, undefined, { game: t })
                );
              };
              WH.ae(
                s,
                WH.Icon.create(a, WH.Icon.LARGE, undefined, { game: t })
              );
              WH.ae(n, s);
              WH.ae(n, e);
            },
            ...
            compute: function (e, t, a, i, n) {
              ...
              l = l.replace(
                ...
                '<a href="' +
                  s +
                  '">' +
                  WH.Types.getLowerPlural(WH.Types.ITEM) +
                  "</a>"
              );
              l = l.replace(
                "$2",
                '<a href="' +
                  r +
                  '">' +
                  WH.Types.getLowerPlural(WH.Types.SPELL) +
                  "</a>"
              );
              l = l.replace(
                "$3",
                '<a href="' +
                  o +
                  '">' +
                  WH.Types.getLowerPlural(WH.Types.ACHIEVEMENT) +
                  "</a>"
              );
              i.innerHTML = l;
            },
    ...
    Icon.icDialog.show("icondisplay", { data: { icon: e, game: t } });
  },
  checkPound: function () {
...
WH.Tooltips =
  ...
  new (function () {
    ...
    const C = (() =>
      [
        ...
        return {
          ...
          envId: e,
          prefixedDetailPageNames:
            i === t.WOW ? [] : n.filter((e) => e !== "guide"),
    ...
    const G = {
      ...
      4: {
        achievementComplete: "$1在$2/$3/$4上获得成就",
        loading: "正在载入…",
        noResponse: "服务器没有响应 :(",
        notFound: "%s未找到",
      },
    ...
    this.clearTouchTooltip = function (e) {
      if ($.touchElement) {
        if (e !== true) {
          $.touchElement.removeAttribute("data-showing-touch-tooltip");
        }
        $.touchElement.hasWHTouchTooltip = false;
      }
      $.touchElement = undefined;
      if (e !== true) {
      ...
      if ($.elements.screen) {
        $.elements.screenInnerWrapper.scrollTop = 0;
        $.elements.screenInnerWrapper.scrollLeft = 0;
    ...
    this.getEntity = function (e, t, a, i) {
      ...
      n[t] = n[t] || {};
      n[t][a] = n[t][a] || {};
      n[t][a][i] = n[t][a][i] || { status: k, callbacks: [], data: {} };
      return n[t][a][i];
    };
    this.init = function () {
      V();
    ...
    this.register = function (t, a, n, s, r) {
      ...
      }
      {
        if (!nt.isLoaded(t, n)) {
          o.status = F;
          nt.registerCallback(t, n, e.register.bind(this, t, a, n, s, r));
          return;
        }
        if (
          typeof a === "string" &&
          (a.indexOf("lvl") === 0 || a.match(/[^i]lvl/)) &&
          !nt.isLoaded(i.SPELL, n)
        ) {
          o.status = F;
          nt.registerCallback(i.SPELL, n, e.register.bind(this, t, a, n, s, r));
          return;
        }
      }
      if (o.timer) {
    ...
    this.replaceWithTooltip = function (a, i, n, s, r, o, l) {
      ...
      switch (d.status) {
        case B:
          ...
          if (!f[i].embeddedIcons && ae(d.data)) {
        ...
        case k:
          d.callbacks.push(
            this.replaceWithTooltip.bind(this, a, i, n, s, r, o, l)
          );
    ...
    if (!WH.REMOTE) {
      ...
      this.attach = function (t, a, i, n) {
        ...
        let s = { dataEnv: n.dataEnv, type: n.type };
        let r = n.stopPropagation ? (e) => e.stopPropagation() : () => {};
        if (n.byCursor) {
          t.onmouseover = function (e) {
            let t = qe(a, n.noWrap, n.maxWidth, e);
            Je(e, t, i, s);
            r(e);
          };
          ...
          t.onmouseover = function (e) {
            let o = qe(a, n.noWrap, n.maxWidth, e);
            Qe(t, o, i, s);
            r(e);
          };
        }
      ...
      this.disableCompletion = function () {
        $.showCharacterCompletion = false;
      };
      this.getScalingData = (e, t) => nt.getDataByKey(e, t);
      this.getScreenshotsEnabled = () => $.showScreenshots;
      this.getTd = () => $.elements.tooltipTd;
      this.isTypeSupported = (e) => f.hasOwnProperty(e);
      this.isVisible = function () {
        return (
          $.showingTooltip ||
          ($.elements.tooltip && WH.DOM.isVisible($.elements.tooltip))
        );
      };
      this.on = (e, t) => {
        if (!$.elements.tooltip) {
      ...
      this.relToParams = (e) => {
        let t = {};
        e.forEach((e) => e.replace(y, (e, a, i) => xe(t, a, i) || ""));
        return t;
      };
      this.setEnabled = (e) => ($.enabled = e);
      this.setScreenshotsEnabled = (e) => ($.showScreenshots = e);
      this.showFadingTooltipAtCursor = function (e, t, a, i, n) {
        e = qe(e, i, n, t);
        Je(t, e, a);
        requestAnimationFrame(function () {
          $.elements.tooltip.classList.add("fade-out");
        });
      };
      ...
      this.finalizeSizeAndReveal = ne;
      this.hide = Se;
      this.prepare = Fe;
      this.setIcon = je;
      this.show = Qe;
      this.showAtCursor = Je;
      this.showAtPoint = Xe;
      this.showInScreen = Ze;
    }
    function j(e, t) {
      if (e.classList) {
    ...
    function Q(e, t) {
      ...
      $.elements.tooltipTable.parentNode.insertBefore(
        i,
        $.elements.tooltipTable.nextSibling
      );
    }
    function J(e) {
    ...
    function te(t, a, i, n, s) {
      ...
      if (o.status === B || o.status === P) {
        at();
      } else if (o.status === D || o.status === F) {
        if (WH.inArray(q, t) === -1) {
          tt(o.status, n, ge(n, "loading"));
        }
      } else {
        Ge(t, a, i, n, WH.inArray(q, t) !== -1, s);
      }
    }
    function ae(e) {
    ...
    function oe(e) {
      if (typeof f[e] !== "object") {
        throw new Error(
          "Wowhead tooltips could not find config for entity type [" + e + "]."
        );
      }
      return f[e].data;
    }
    function le(e) {
      ...
      return {
        min: f[e].hasOwnProperty("minId") ? f[e].minId : 1,
        max: f[e].maxId,
      };
    }
    function ce(e) {
    ...
    function fe(e, t, a) {
      ...
      return (
        ...
        (a["crafted-stats"]
          ? "craftedStats" + a["crafted-stats"].join(",")
          : "") +
        (a["crafting-quality"]
          ? "craftingQuality" + a["crafting-quality"]
          : "") +
        (a.q ? "q" + a.q : "") +
        ...
        (a["azerite-essence-powers"]
          ? "aePowers" + a["azerite-essence-powers"]
          : "") +
        (a.nomajor ? "nomajor" : "") +
    ...
    function ue() {
      return $.show.params && $.show.params.text ? "text_icon" : "icon";
    }
    function pe(e) {
    ...
    function he(e, t, a) {
      ...
      if (n) {
        if (n.screenshot && n.screenshot.id) {
          return [
            WH.getScreenshotUrl(n.screenshot.id, "small", {
          ...
          if (
            ...
            (n.jsonequip.slotbak &&
              !WH.Wow.Item.isArmorInvType(n.jsonequip.slotbak))
          ) {
            a = undefined;
          }
    ...
    function Ee() {
      return ($.show.params && $.show.params.buff ? "buff" : "") + "spells";
    }
    function Te(e) {
      var t = "tooltip";
      if ($.show.params && $.show.params.buff) t = "buff";
      if ($.show.params && $.show.params.text) t = "text";
      if ($.show.params && $.show.params.premium) t = "tooltip_premium";
      return t + (e || "");
    }
    function ve(e) {
      e = e || "www";
    ...
    function Se() {
      ...
      if ($.elements.tooltip2) {
        $.elements.tooltip2.style.display = "none";
        Ve($.elements.tooltip2, false);
        $.elements.tooltipTable2.className = "";
      }
    }
    function Ie(e, n, s, r) {
    ...
    function be() {
      if (WH.REMOTE) {
        ...
        V();
        Me(function () {
          nt.fetch(i.ITEM, WH.getDataEnv());
          nt.fetch(i.SPELL, WH.getDataEnv());
        });
      }
    }
    function ye() {
      ...
      for (var i in e) {
        ...
        if (a.insertRule) {
          a.insertRule(
            ".wowhead-tooltip .whtt-" + i + "{display: none}",
            a.cssRules.length
          );
        } else if (a.addRule) {
    ...
    function we() {
      if (!$.mobileScrollInitialized) {
        let e = function (e) {
          if ($.usingScreen) {
            if (
              !document
                .getElementById("wowhead-tooltip-screen-inner")
                .contains(e.target)
            ) {
              e.preventDefault();
            }
      ...
      setTimeout(function () {
        ...
        $.iScroll = new IScroll($.elements.screenInnerWrapper, {
          mouseWheel: true,
          tap: true,
        });
      }, 1);
    ...
    function Ce(t, a, n, s, o, l, c, d) {
      ...
      Menu.add(
        this,
        f,
        { noEvents: true, showAtElement: true, showImmediately: true },
        d
      );
    }
    function Me(e) {
    ...
    function De(e) {
      ...
      if (i === O) {
        ...
        $.touchElement = t;
        $.touchElement.hasWHTouchTooltip = true;
    ...
    function Pe(e, a) {
      ...
      if (
        [WH.dataEnv.BETA, WH.dataEnv.PTR, WH.dataEnv.PTR2].indexOf(i.dataEnv) >=
        0
      ) {
        i.locale = 0;
      }
      ...
      switch (s.type) {
        case i.AZERITE_ESSENCE_POWER:
          ...
          if (s.params.spec && !(s.params.know && s.params.know.length)) {
            nt.getSpellsBySpec(s.params.spec, function (e) {
              t = t.replace(/<!--embed:([^>]+)-->/g, function (t, a) {
                return WH.setTooltipSpells(
                  r.data.embeds[a].tooltip,
                  e,
                  r.data.embeds[a].spells
                );
              });
              n(t);
            });
    ...
    function Fe(e, a, i, n, s) {
      if (!$.elements.tooltip) {
        ...
        $.elements.tooltipTd2 = WH.gE(a, "td")[0];
      }
    ...
    function Ue() {
      if ($.elements.screen) {
        ...
        $.elements.screenInnerWrapper = WH.ce("div", {
        ...
        $.elements.screenInnerBox = WH.ce("div", {
          id: "wowhead-tooltip-screen-inner-box",
          className: "wowhead-tooltip-screen-inner-box",
        });
        $.elements.screenCaption = WH.ce("div", {
          id: "wowhead-tooltip-screen-caption",
          className: "wowhead-tooltip-screen-caption",
        });
        WH.ae($.elements.screen, e);
        WH.ae(t, $.elements.screenInnerBox);
        WH.ae($.elements.screenInnerWrapper, t);
        WH.ae($.elements.screen, $.elements.screenInnerWrapper);
        WH.ae($.elements.screen, $.elements.screenCaption);
        WH.ae(document.body, $.elements.screen);
      }
      $.usingScreen = true;
      we();
    }
    ...
    function Ge(t, a, s, r, o, l) {
      var c = fe(t, a, l);
      let d = e.getEntity(t, c, s, r);
      if (d.status !== k && d.status !== x) {
        return;
      }
      d.status = D;
      var f = le(t);
      ...
      if (!o) {
        d.timer = setTimeout(et.bind(this, t, c, s, r), 333);
      }
      var u = [];
      for (var p in l) {
        switch (p) {
      ...
      if (
        t === i.ITEM &&
        l &&
        l.hasOwnProperty("lvl") &&
        !nt.isLoaded(i.SPELL, s)
      ) {
        nt.fetch(i.SPELL, s);
      }
    ...
    function ze(a, n, r) {
      ...
      if (
        ...
        (z && a.getAttribute("data-disable-wowhead-touch-tooltip") === "true")
      ) {
        return N;
      }
        ...
        if (e) {
          ...
          C.some((e) => {
            ...
            if (t) {
              ...
              _ =
                (e.prefixedDetailPageNames.includes(t[2])
                  ? e.detailPagePrefix
                  : "") + t[2];
              A = t[3];
              x = l;
      ...
      if (o && (!_ || /\bignore-url\b/.test(o))) {
        ...
        C.forEach((t) => {
          if (t.prefixedDetailPageNames.length) {
            e = e.concat(
              t.prefixedDetailPageNames.map((e) => t.detailPagePrefix + e)
            );
          } else {
      ...
      l.replace(y, (e, t, a) => xe(W, t, a) || "");
      if (o) {
        o.replace(y, (e, t, a) => xe(W, t, a) || "");
      }
      ...
      let J = Q.dataEnv;
      let X = Q.locale;
      let Z = WH.Types.getRequiredTrees(P) || [];
      if (Z.length && !Z.includes(WH.getDataTree(J))) {
        J = WH.getRootByTree(Z[0]);
      }
      if (
        l.indexOf("#") !== -1 &&
        document.location.href.indexOf(_ + "=" + A) !== -1
      ) {
        return N;
      }
      $.show.mode = H;
      if (
        z &&
        !a.dataset.noTouchLightbox &&
        document.documentElement.offsetWidth < s
      ) {
        $.show.mode = I;
      } else if (
        ...
        if (
          ...
          while (ee) {
            if (
              ((ee.getAttribute && ee.getAttribute("class")) || "").indexOf(
                "menu-inner"
              ) === 0
            ) {
              $.show.mode = v;
      ...
      if ($.show.mode === H && a.dataset.whtticon === "false") {
        $.show.mode = E;
      }
      if (!WH.REMOTE && !a.whContextMenuAttached) {
        a.whContextMenuAttached = true;
        WH.aE(a, "contextmenu", Ce.bind(a, J, X, P, _, A, W, x));
      }
      if (n) {
      ...
      let ne = e.getEntity(P, fe(P, A, W), J, X);
      var se = [];
      if (
        (me("renameLinks") &&
      ...
      if ((re || me("iconizeLinks")) && d.includes(P)) {
        if (!re) {
          re = me("iconSize");
        }
        se.push(function () {
          if (ae(ne.data) && a.dataset.whIconAdded !== "true") {
            Ie(a, P, ne.data, re);
          }
        });
      }
    ...
    function $e(t, a, i, n) {
      $.elements.tooltip.style.width = "550px";
      $.elements.tooltip.style.left = "-2323px";
      $.elements.tooltip.style.top = "-2323px";
      $.elements.tooltip.className = "wowhead-tooltip";
      if (t.nodeName) {
        WH.ee($.elements.tooltipTd);
        WH.ae($.elements.tooltipTd, t);
      } else {
        if ($.elements.tooltip.dataset.game === "wow") {
          t = e.evalFormulas(t);
        }
        $.elements.tooltipTd.innerHTML = t;
      }
      $.elements.tooltip.style.display = "";
      Ve($.elements.tooltip, true);
      ie($.elements.tooltip, true);
      if (a) {
        $.showSecondary = true;
        $.elements.tooltip2.style.width = "550px";
        $.elements.tooltip2.style.left = "-2323px";
        $.elements.tooltip2.style.top = "-2323px";
        if (a.nodeName) {
          WH.ee($.elements.tooltipTd2);
          WH.ae($.elements.tooltipTd2, a);
        } else {
          $.elements.tooltipTd2.innerHTML = e.evalFormulas(a);
        }
        $.elements.tooltip2.style.display = "";
        ie($.elements.tooltip2, true);
      } else {
        $.showSecondary = false;
      }
      if (WH.Device.isTouch()) {
      ...
      $.elements.tooltipTable.style.display = t == "" ? "none" : "";
      Q(i, n);
      se("show");
    }
    function je(e, t, a) {
      Ke($.elements.icon, e ? { icon: e } : undefined, t, a);
    }
    function Ye(e) {
      let t;
      if (e.showIcon !== false) {
      ...
      Ke($.elements.icon, t, e.type, e.dataEnv);
    }
    function Ke(e, t, a, i) {
      WH.ee(e);
      ...
      if (ae(t)) {
        WH.ae(
          e,
          WH.Icon.createByEntity(t, a, null, {
            dataEnv: i,
            size: WH.Icon.MEDIUM,
          })
        );
    ...
    function Qe(e, t, a, i) {
      ...
      Ye(i);
      $e(t, i.text2, i.image, i.imageClass);
      Le(
    ...
    function Xe(e, t, a, i) {
      ...
      i = i || {};
      Fe(i.dataEnv, i.type, i.fixedPosition, undefined, i.status);
      Ye(i);
      $e(e, i.text2, i.image, i.imageClass);
    ...
    function Ze(e, t, a) {
      ...
      Ye(a);
      $e(t, a.text2, a.image, a.imageClass);
      Le();
    }
    function et(t, a, i, n) {
      if (
    ...
    function tt(t, n, s, r, d, f, u, h, W, b) {
      ye();
      if (!$.initiatedByUser) {
        return;
      }
      if ($.element) {
        if ($.element._fixTooltip) {
          s = $.element._fixTooltip(s, $.show.type, $.show.fullId, $.element);
        }
        if ($.element._fixTooltip2) {
          h = $.element._fixTooltip2(h, $.show.type, $.show.fullId, $.element);
        }
      }
      if (!s) {
        s = ge(n, "notFound").replace("%s", ce($.show.type));
        t = P;
        d = a.UNKNOWN;
      } else if ($.show.params) {
        let e = $.show.params;
        if (WH.reforgeStats && e.forg && WH.reforgeStats[e.forg]) {
          ...
          var w = [y.i1];
          for (var _ in WH.individualToGlobalStat) {
            if (WH.individualToGlobalStat[_] === w[0]) {
              w.push(_);
            }
          }
          var A;
          if (
            (A = s.match(
              new RegExp(
                "(\x3c!--(stat|rtg)(" + w.join("|") + ")--\x3e)[+-]?([0-9]+)"
              )
            )) &&
            !s.match(
              new RegExp("\x3c!--(stat|rtg)" + y.i2 + "--\x3e[+-]?[0-9]+")
            )
          ) {
            var L = Math.floor(A[4] * y.v),
              R = p.traits[y.s2][0];
            if (y.i2 == 6) {
              s = s.replace("\x3c!--rs--\x3e", "<br />+" + L + " " + R);
            } else {
              s = s.replace(
                "\x3c!--rr--\x3e",
                WH.sprintfGlobal(g.genericequip_tip, R.toLowerCase(), y.i2, L)
              );
            }
            s = s.replace(A[0], A[1] + (A[4] - L));
            s = s.replace(
              "\x3c!--rf--\x3e",
              '<span class="q2">' +
                WH.sprintfGlobal(
        ...
        if (e.pcs && e.pcs.length) {
          var C = 0;
          for (var _ = 0, M = e.pcs.length; _ < M; ++_) {
            var A;
            var N = new RegExp(
              "<span>\x3c!--si([0-9]+:)*" +
                e.pcs[_] +
            ...
            if ((A = s.match(N))) {
              let t = !isNaN(parseInt($.show.locale))
                ...
                : "enus";
              var O =
                WH.isSet("g_items") && g_items[e.pcs[_]]
                  ? g_items[e.pcs[_]]["name_" + t]
                  : A[4];
              let a = WH.REMOTE
                ? "javascript:"
          ...
          if (C > 0) {
            s = s.replace("(0/", "(" + C + "/");
            s = s.replace(
              new RegExp("<span>\\(([0-" + C + "])\\)", "g"),
              '<span class="q2">($1)'
            );
          }
        }
        if (e.know && e.know.length) {
          s = WH.setTooltipSpells(s, e.know, u);
        }
        if (e.lvl && !e.ilvl) {
        ...
        if ($.show.type === i.BATTLE_PET_ABILITY && e.pwr) {
          s = s.replace(/<!--sca-->(\d+)<!--sca-->/g, function (t, a) {
            return Math.floor(parseInt(a) * (1 + 0.05 * e.pwr));
          });
        }
        if ($.show.type === i.ACHIEVEMENT && e.cri) {
          for (var _ = 0; _ < e.cri.length; _++) {
            s = s.replace(
              new RegExp("\x3c!--cr" + parseInt(e.cri[_]) + ":[^<]+", "g"),
              '<span class="q2">$&</span>'
            );
          }
        }
      ...
      if (
        $.showCharacterCompletion &&
        window.g_user &&
        ((WH.isRetailTree($.show.dataEnv) && g_user.lists) ||
          (!WH.isRetailTree($.show.dataEnv) &&
        ...
        let r = !(
          ...
          WH.inArray(
            g_completion_categories[$.show.type],
            n.completion_category
          ) === -1
        );
        let o = /^-?\d+(?:\.\d+)?/.exec($.show.fullId);
        o = o && o.length ? o[0] : $.show.fullId;
        if (a) {
          for (var F in g_user.lists) {
            var U = g_user.lists[F];
            if (!(U.id in a)) {
              continue;
            }
            ...
            x +=
              ...
              (e ? "progress-8" : "progress-0") +
              '"></span> ';
            x += U.character + " - " + U.realm + " " + U.region;
          }
        }
        if (!WH.isRetailTree($.show.dataEnv) && $.show.type === i.QUEST) {
          for (var q, _ = 0; (q = g_user.characterProfiles[_]); _++) {
          ...
          (g_user.lists || []).forEach(function (e) {
            ...
            if (t > 0) {
              x +=
                ...
                '"></span> ';
              x += e.character + " - " + e.realm + " " + e.region;
            }
          });
        }
        if (x !== "") {
          s += '<br><span class="q">' + WH.TERMS.completion + ":</span>" + x;
        }
      }
      if (
        !WH.REMOTE &&
        ...
        if (r) {
          if (
            ...
            !$.element.dataset.tooltipIgnoreRequiredRace
          ) {
          ...
          r.parentNode.replaceChild(
            WH.ce("img", {
              src: e.getThumbUrl($.show.fullId, t, a, $.show.dataEnv),
              width: 260,
              height: 440,
      ...
      if (
        !WH.REMOTE &&
        s &&
        ($.show.params.diff || $.show.params.diffnew || $.show.params.noimage)
      ) {
        W = "";
        b = "";
      }
      ...
      let G = function (e, t, a) {
        if (
          ...
          $.show.dataEnv !== t.dataEnv ||
          $.show.locale !== t.locale ||
          $.show.params !== t.params
        ) {
          return;
        }
        switch ($.show.mode) {
          ...
          case v:
            ...
            break;
          case E:
            Xe(a, $.cursorX, $.cursorY, {
              dataEnv: t.dataEnv,
              entity: r,
              fixedPosition: WH.isElementPositionFixedOrSticky($.element),
              image: W,
              imageClass: b,
              padX: l,
              padY: c,
    ...
    function at() {
      ...
      if (q.includes($.show.type) && !t.data[Te()]) {
        Oe();
        return;
      }
    ...
    let nt = new (function () {
      ...
      this.fetch = function (e, t) {
        ...
        if (WH.REMOTE) {
          ...
          i = WH.Url.getDataPageUrl(s[e].replace("/data/", ""));
        }
        i += "&json";
        WH.xhrJsonRequest(
          i,
